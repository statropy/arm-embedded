...
RUN wget -q https://developer.arm.com/-/media/Files/downloads/gnu/13.2.Rel1/binrel/arm-gnu-toolchain-13.2.Rel1-$platform-arm-none-eabi.tar.xz \
    && tar xf arm-gnu-toolchain-13.2.Rel1-$platform-arm-none-eabi.tar.xz -C /opt \
    && rm arm-gnu-toolchain-13.2.Rel1-$platform-arm-none-eabi.tar.xz
...
ENV PATH="/opt/arm-gnu-toolchain-13.2.Rel1-$platform-arm-none-eabi/bin:${PATH}"
